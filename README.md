...
Quite a few coordinates have typos ([DEIWR](https://unlocode.info/DEIWR)), are in the wrong hemisphere ([BOSCS](https://unlocode.info/BOSCS)), or are just flat out wrong ([EGSCN](https://unlocode.info/EGSCN))
